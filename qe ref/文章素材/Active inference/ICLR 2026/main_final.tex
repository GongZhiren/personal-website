...
\author{
\textbf{Zhiren Gong}$^{1,2}$\thanks{Work done as a research assistant at The Chinese University of Hong Kong, Shenzhen.}\mbox{, }
\textbf{Chao Yang}$^1$,
\textbf{Wendi Ren}$^1$,
\textbf{Shuang Li}$^1$\thanks{Corresponding author.}
\\
$^1$The Chinese University of Hong Kong, Shenzhen \quad $^2$Nanyang Technological University
\\
\texttt{zhiren001@e.ntu.edu.sg, 222043011@link.cuhk.edu.cn,}\\
\texttt{wendiren@link.cuhk.edu.cn, lishuang@cuhk.edu.cn}
}
...
$
Here, the latent world prototype $S_f^\star$ encodes the spatial situation of nearby cars and 
discrete mode $m_f^\star$ denotes cautious intention. When this familiar combination recurs, the 
...
The overall framework alternates between two coupled processes with details provided in Appendix~\ref{Sec:A}:  
\begin{enumerate}
...
and then perform \emph{full wake--sleep} cycles with replay using the joint objective in Eq.~\ref{eq:total_objective} (Stage~2). 
...
& RNNLogic & \makecell[c]{67.20/60.55/51.83\\[-3pt]
\revise{{\scriptsize (±0.00 / ±0.33 / ±1.50)}}} & \makecell[c]{\textbf{26.90}/\textbf{1.20}\\[-3pt]
\revise{{\scriptsize (±0.82 / ±0.00)}}} & \makecell[c]{72.33/68.14/57.56\\[-3pt]
\revise{{\scriptsize (±1.26 / ±1.16 / ±1.45)}}} & \makecell[c]{\textbf{7.58}/\textbf{0.54}\\[-3pt]
\revise{{\scriptsize (±1.08 / ±0.00)}}} \\
& STLR     & \makecell[c]{75.25/74.67/70.20\\[-3pt]
\revise{{\scriptsize (±0.45 / ±0.72 / ±1.15)}}} & \makecell[c]{174.18/3.35\\[-3pt]
\revise{{\scriptsize (±0.75 / ±0.33)}}} & \makecell[c]{78.90/76.57/75.03\\[-3pt]
\revise{{\scriptsize (±1.50 / ±1.82 / ±2.35)}}} & \makecell[c]{58.29/1.28\\[-3pt]
\revise{{\scriptsize (±0.63 / ±0.20)}}} \\
DeepNN & Re-Net & \makecell[c]{72.18/68.45/62.00\\[-3pt]
\revise{{\scriptsize (±0.67 / ±0.45 / ±0.67)}}} & \makecell[c]{218.42/2.34\\[-3pt]
\revise{{\scriptsize (±3.25 / ±0.00)}}} & \makecell[c]{76.32/70.71/67.28\\[-3pt]
\revise{{\scriptsize (±0.83 / ±1.25 / ±2.06)}}} & \makecell[c]{72.23/1.15\\[-3pt]
\revise{{\scriptsize (±2.18 / ±0.00)}}} \\
\multirow{2}{*}{Active Inf.}
& DAI      & \makecell[c]{75.36/70.58/62.33\\[-3pt]
\revise{{\scriptsize (±1.12 / ±1.48 / ±1.55)}}} & \makecell[c]{262.33/1.24\\[-3pt]
\revise{{\scriptsize (±4.43 / ±0.01)}}} & \makecell[c]{78.86/73.35/68.50\\[-3pt]
\revise{{\scriptsize (±0.42 / ±0.28 / ±0.53)}}} & \makecell[c]{146.33/0.62\\[-3pt]
\revise{{\scriptsize (±1.31 / ±0.01)}}} \\
& DAI-MC   & \makecell[c]{82.33/80.61/76.47\\[-3pt]
\revise{{\scriptsize (±0.87 / ±0.85 / ±1.24)}}} & \makecell[c]{386.50/1.52\\[-3pt]
\revise{{\scriptsize (±3.62 / ±0.05)}}} & \makecell[c]{84.54/82.87/80.25\\[-3pt]
\revise{{\scriptsize (±0.34 / ±0.36/ ±0.76)}}} & \makecell[c]{189.75/0.79\\[-3pt]
\revise{{\scriptsize (±1.55 / ±0.01)}}} \\
\multirow{2}{*}{LLM-based}
& LaTee    & \makecell[c]{78.50/73.32/64.50\\[-3pt]
\revise{{\scriptsize (±0.88 / ±1.72 / ±1.06)}}} & \makecell[c]{1244.20/4.65\\[-3pt]
\revise{{\scriptsize (±10.07 / ±0.90)}}} & \makecell[c]{82.36/74.75/71.82\\[-3pt]
\revise{{\scriptsize (±1.65/ ±1.12 / ±1.48)}}} & \makecell[c]{528.33/2.46\\[-3pt]
\revise{{\scriptsize (±8.15 / ±0.76)}}} \\
& \revise{Qwen-0.5B} & \makecell[c]{71.25/64.18/56.42\\[-3pt]
\revise{{\scriptsize (±1.12 / ±1.85 / ±1.28)}}} & \makecell[c]{2845.35/N/A\\[-3pt]
\revise{{\scriptsize (±12.45 / ---)}}} & \makecell[c]{74.85/68.32/62.15\\[-3pt]
\revise{{\scriptsize (±1.88 / ±1.45 / ±1.62)}}} & \makecell[c]{1256.82/N/A\\[-3pt]
\revise{{\scriptsize (±9.25 / ---)}}} \\
Model-based RL & DreamerV2 & \makecell[c]{86.42/83.57/81.65\\[-3pt]
\revise{{\scriptsize (±0.47 / ±0.66 / ±0.72)}}} & \makecell[c]{52.73/1.75\\[-3pt]
\revise{{\scriptsize (±3.25 / ±0.05)}}} & \makecell[c]{88.43/85.38/82.33\\[-3pt]
\revise{{\scriptsize (±0.54 / ±0.78 / ±1.00)}}} & \makecell[c]{38.57/0.92\\[-3pt]
\revise{{\scriptsize (±1.04 / ±0.00)}}} \\
\textbf{Ours} & &
\makecell[c]{\textbf{97.00/91.32/85.69}\\[-3pt]
\revise{{\scriptsize (±0.51 / ±0.79 / ±0.89)}}}
&
\makecell[c]{35.92/2.59\\[-3pt]
\revise{{\scriptsize (±2.78 / ±0.22)}}}
&
\makecell[c]{\textbf{96.77/95.87/94.16}\\[-3pt]
\revise{{\scriptsize (±0.34 / ±0.40 / ±0.47)}}}
&
\makecell[c]{10.44/0.65\\[-3pt]
\revise{{\scriptsize (±0.59 / ±0.08)}}}
\\
\midrule
\multirow{2}{*}{Category} & \multirow{2}{*}{Method}
...
\midrule
\multirow{2}{*}{Logic-based}
& RNNLogic & \makecell[c]{18.75/16.29/13.28\\[-3pt]
\revise{{\scriptsize (±0.00 / ±0.67 / ±1.83)}}} & \makecell[c]{\textbf{124.32}/\textbf{4.36}\\[-3pt]
\revise{{\scriptsize (±5.71 / ±0.39)}}} & \makecell[c]{33.86/27.50/24.38\\[-3pt]
\revise{{\scriptsize (±0.34 / ±0.57 / ±0.37)}}} & \makecell[c]{\textbf{72.46}/\textbf{2.04}\\[-3pt]
\revise{{\scriptsize (±3.27 / ±0.00)}}} \\
& STLR     & \makecell[c]{22.45/18.33/15.59\\[-3pt]
\revise{{\scriptsize (±0.00 / ±0.50 / ±1.18)}}} & \makecell[c]{872.00/10.25\\[-3pt]
\revise{{\scriptsize (±10.53 / ±0.74)}}} & \makecell[c]{45.50/38.72/37.24\\[-3pt]
\revise{{\scriptsize (±0.67 / ±1.83/ ±2.25)}}} & \makecell[c]{432.35/7.18\\[-3pt]
\revise{{\scriptsize (±8.20 / ±0.58)}}} \\
DeepNN & Re-Net & \makecell[c]{27.33/20.18/16.17\\[-3pt]
\revise{{\scriptsize (±1.32 / ±1.54/ ±1.76)}}} & \makecell[c]{1112.42/16.38\\[-3pt]
\revise{{\scriptsize (±10.62 / ±0.42)}}} & \makecell[c]{40.69/32.48/29.33\\[-3pt]
\revise{{\scriptsize (±0.75 / ±0.50/ ±1.84)}}} & \makecell[c]{723.02/4.42\\[-3pt]
\revise{{\scriptsize (±5.48 / ±0.30)}}} \\
\multirow{2}{*}{Active Inf.}
& DAI      & \makecell[c]{46.82/39.27/34.20\\[-3pt]
\revise{{\scriptsize (±0.82 / ±1.24/ ±1.33)}}} & \makecell[c]{2033.25/3.88\\[-3pt]
\revise{{\scriptsize (±4.59 / ±0.27)}}} & \makecell[c]{59.97/52.28/41.46\\[-3pt]
\revise{{\scriptsize (±0.72 / ±0.95 / ±1.30)}}} & \makecell[c]{977.24/3.67\\[-3pt]
\revise{{\scriptsize (±5.51 / ±0.93)}}} \\
& DAI-MC   & \makecell[c]{57.20/52.15/43.67\\[-3pt]
\revise{{\scriptsize (±0.67 / ±1.24/ ±1.49)}}} & \makecell[c]{2304.23/4.75\\[-3pt]
\revise{{\scriptsize (±6.29 / ±0.47)}}} & \makecell[c]{66.82/58.20/48.20\\[-3pt]
\revise{{\scriptsize (±0.64 / ±0.77/ ±0.90)}}} & \makecell[c]{1429.00/4.95\\[-3pt]
\revise{{\scriptsize (±4.87 / ±0.74)}}} \\
\multirow{2}{*}{LLM-based}
& LaTee    & \makecell[c]{28.16/22.14/20.38\\[-3pt]
\revise{{\scriptsize (±0.32 / ±0.67/ ±0.92)}}} & \makecell[c]{95028.72/20.39\\[-3pt]
\revise{{\scriptsize (±45.88 / ±0.82)}}} & \makecell[c]{62.18/54.21/49.28\\[-3pt]
\revise{{\scriptsize (±0.46 / ±0.68 / ±0.94)}}} & \makecell[c]{3230.43/11.64\\[-3pt]
\revise{{\scriptsize (±7.61 / ±0.84)}}} \\
& \revise{Qwen-0.5B} & \makecell[c]{24.85/19.62/17.35\\[-3pt]
\revise{{\scriptsize (±0.42 / ±0.78 / ±1.05)}}} & \makecell[c]{125842.15/N/A\\[-3pt]
\revise{{\scriptsize (±52.35 / ---)}}} & \makecell[c]{58.42/51.25/46.18\\[-3pt]
\revise{{\scriptsize (±0.58 / ±0.85 / ±1.12)}}} & \makecell[c]{4856.72/N/A\\[-3pt]
\revise{{\scriptsize (±8.75 / ---)}}} \\
Model-based RL & DreamerV2 & \makecell[c]{64.05/61.48/58.15\\[-3pt]
\revise{{\scriptsize (±0.81 / ±0.99 / ±1.03)}}} & \makecell[c]{452.25/10.08\\[-3pt]
\revise{{\scriptsize (±5.36 / ±0.80)}}} & \makecell[c]{76.33/72.18/69.47\\[-3pt]
\revise{{\scriptsize (±0.67 / ±1.08 /±1.33)}}} & \makecell[c]{108.02/6.87\\[-3pt]
\revise{{\scriptsize (±0.98 / ±0.24)}}} \\
\textbf{Ours} & &
\makecell[c]{\textbf{79.63/73.58/68.07}\\[-3pt]
\revise{{\scriptsize (±1.54 / ±2.62 / ±2.60)}}}
&
\makecell[c]{159.45/8.73\\[-3pt]
\revise{{\scriptsize (±4.45 / ±0.29)}}}
&
\makecell[c]{\textbf{85.55/77.20/72.44}\\[-3pt]
\revise{{\scriptsize (±0.87 / ±0.92 / ±1.05)}}}
&
\makecell[c]{92.63/3.53\\[-3pt]
\revise{{\scriptsize (±2.29 / ±0.15)}}}
\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[t]{\linewidth}
    ...
    \begin{subfigure}[t]{0.47\linewidth}
      ...
      \caption*{(iv) Rule-guided inference with world-model.}
    \end{subfigure}
...
\section*{Reproducibility Statement} We have made extensive efforts to ensure the reproducibility of our results. The complete description of both synthetic dataset generation and real-world dataset preprocessing methods are illustrated in Appendix \ref{Sec:B}. Details of the computational setup, including hardware configuration and software environment, as well as the choice of hyper-parameters are documented in Appendix~\ref{Sec:B7}. We also release our code.
 
\section*{Acknowledgments}
This work was in part supported by the Key Program of the NSFC under grant No. 72495131, the Shenzhen Stability Science Program 2023, the Shenzhen Science and Technology Program No.~JCYJ20250604141038013, and Longgang District Key Laboratory of Intelligent Digital Economy Security.
...
\begin{figure*}[t]
    ...
    \subfloat[DDXPlus]{%
        \includegraphics[width=0.46\linewidth]{ICLR 2026/Fig/action_dist_ddxplus.pdf}
    }
    \hfill
    \subfloat[Atari–Berzerk]{%
        \includegraphics[width=0.44\linewidth]{ICLR 2026/Fig/action_dist_atari.pdf}
    }
...
\begin{figure*}[t]
  \centering
  \subfloat[NBA SportVU]{%
    \includegraphics[width=.505\linewidth]{ICLR 2026/Fig/nba/testing_metrics_from_csv.pdf}}
  \hfill
  \subfloat[Car-Following]{%
    \includegraphics[width=.455\linewidth]{ICLR 2026/Fig/car_following/testing_metrics_from_csv.pdf}}\\[-0.2em]
  \subfloat[DDXPlus]{%
