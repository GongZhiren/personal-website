...
\title{ Channel Gains to Captions: Task-Unified Multi-Level RF Sensing with Vision-Language Models}
...
\begin{tabular}{
  ...
  >{\centering\arraybackslash}p{0.37\textwidth}}\hline
...
\begin{figure}[!t]
\center
\includegraphics[width=0.7\linewidth] {letter_1.pdf}
...
\begin{tabular}{|
  >{\centering\arraybackslash}m{0.209\textwidth}|
